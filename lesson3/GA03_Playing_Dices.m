function Playing_Dices
%%Group Assignment 03: Playing dices
...
N=100000; %Number of plays (simulaations)
...
for i=1:N
    ...
    if X1==6
        n1_6=n1_6+1; %Count number of plays with 1st roll=6
        if X2+X3>=6
...
%Q4: Pr(X=8)
Pr_8=n(8)/N %Relative frequency probability
pmf_8=pmf(8) %pmf probalitily
...
Pr_6_12=n23_6/n1_6 %1st roll=6 and sum>=6
